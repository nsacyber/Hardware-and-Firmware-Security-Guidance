...
- 4\. [Boot configuration](#boot-config)
...
## 1. About this respository<a name="about"/>
...
## 2. Side-channel vulnerabilities<a name="scvuln"/>
### 2.1 Mitigations<a name="mitigations"/>
#### 2.1.1 Firmware updates<a name="firmpatch"/>
...
#### 2.1.2 Software patches<a name="softpatch"/>
...
#### 2.1.3 Configuration changes<a name="config"/>
...
### 2.2 Affected products<a name="products"/>
...
#### 2.2.1 Hardware resources<a name="hardresourses"/>
...
#### 2.2.2 Software Resources<a name="softresources"/>
...
#### 2.2.3 Advisory resources<a name="advisories"/>
...
### 2.3 Publicized attacks<a name="attacks"/>
#### 2.3.1 Spectre | CVE-2017-5715, CVE-2017-5753, CVE-2018-3639, and CVE-2018-3665<a name="spectre"/>
...
#### 2.3.2 Meltdown | CVE-2017-5754 and CVE-2018-3640<a name="meltdown"/>
...
#### 2.3.3 Foreshadow | CVE-2018-3615, CVE-2018-3620, and CVE-2018-3646<a name="foreshadow"/>
...
#### 2.3.4 BranchScope | CVE-2018-9056<a name="branchscope"/>
...
#### 2.3.5 TLBleed | No CVE issued<a name="tlbleed"/>
...
#### 2.3.6 PortSmash | CVE-2018-5407<a name="portsmash"/>
...
#### 2.3.7 NetSpectre | No CVE issued<a name="netspectre"/>
...
## 3. Firmware and microcode vulnerabilities<a name="firmandmicro"/>
### 3.1 LoJax<a name="lojax"/>
...
### 3.2 Ryzenfall, Chimera, Fallout, and Masterkey<a name="amdflaws"/>
...
## 4. Boot configuration<a name="boot-configuration"/>

### 4.1 UEFI Hardening<a name="uefi-hardening"/>
...
### 4.2 UEFI Secure Boot Customization<a name="sbcustom"/>
See UEFI Secure Boot Customization technical report.

## 5. License<a name="license"/>
See [LICENSE](./LICENSE.md).

## 6. Contributing<a name="contributing"/>
See [CONTRIBUTING](./CONTRIBUTING.md)

## 7. Disclaimer<a name="disclaimer"/>
